...
export const Header: React.FC<HeaderProps> = ({
  ...
  /* ---------------------------------------------
     SCENARIO BUTTON
  --------------------------------------------- */
  const handleScenarioChange = (nextScenario: SimulationScenario) => {
            ...
            <div className="space-y-3 text-xs leading-relaxed text-slate-300">
              ...
              <div className="rounded-lg border border-slate-800 bg-[#090d16] p-3">
                ...
                <p className="text-slate-400">
                  ...
                  in Iron Ore Mining Industry: Intelligent Monitoring
                  and Prediction using Multi-Sensor Fusion and Edge
                  Machine Learning.
                </p>
              </div>
